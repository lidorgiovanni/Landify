      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          <div>
            <a href="#" className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xl font-bold text-white">Landify</span>
            </a>
          ...
          <div>
            <p className="text-white/60 text-xs font-semibold uppercase tracking-wider mb-4">יצירת קשר</p>
            <div className="space-y-3">
              <a
                href="https://wa.me/972543495645"
                target="_blank"
        ...
        <div className="border-t border-white/10 pt-6 text-center">
          <p className="text-white/25 text-xs">
            © {new Date().getFullYear()} Landify. כל הזכויות שמורות.
          </p>
        </div>
      </div>
    </footer>
