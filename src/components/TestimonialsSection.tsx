  ...
  return (
    <section id="testimonials" className="section-padding bg-navy text-primary-foreground overflow-hidden">
      ...
      <div className="relative overflow-hidden">
        <div className="flex animate-scroll-left gap-5 w-max px-4">
          {[...testimonials, ...testimonials].map((t, i) => (
            <div key={i} className="glass-card-dark p-6 w-80 shrink-0 rounded-2xl flex flex-col justify-between">
              <div>
        ...
        {/* fade edges */}
        <div className="absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-[hsl(194_100%_10%)] to-transparent pointer-events-none" />
        <div className="absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[hsl(194_100%_10%)] to-transparent pointer-events-none" />
      </div>
    </section>
  );
};
